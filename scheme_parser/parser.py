...
from scheme_types.tagged_types import serialize
...
def parse_scheme(mode: ParsingMode, code: str):
    match mode:
        case ParsingMode.READER:
            required_parser = sexps_parse
        case ParsingMode.TAG_PARSER:
            required_parser = exprs_parse
        case ParsingMode.SEMANTIC_ANALYZER:
            required_parser = exprs_tag_parse
        case _:
            raise ValueError(f"Unknown mode: {mode}")

    results = required_parser(code)
